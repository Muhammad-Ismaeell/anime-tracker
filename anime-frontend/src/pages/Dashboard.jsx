...
function Dashboard() {
    ...
    const recentlyCompleted = Array.isArray(
    ...
    const episodesAvailable = Math.max(
        ...
        <PageContainer>
            ...
            >
                ...
                <button
                    ...
                    className="stat-card glass dashboard-stat-button"
                    onClick={() =>
                        navigate("/library?status=watching")
                    }
                >
                    <span>📺</span>
            ...
            <section className="section">
                ...
                <div className="dashboard-progress glass">
                    <div className="progress-header">
                        <div>
                            <h3>{progress.episodes_watched || 0}</h3>
                ...
                {currentlyWatching.length === 0 ? (
                    ...
                    <div className="dashboard-watching-list">
                        {currentlyWatching.map((anime) => {
                            ...
                            const percentage = getAnimeProgress(
                                currentProgress,
                                episodeCount
                            );
                ...
                {recentActivity.length === 0 ? (
                    ...
                    <div className="activity-list glass">
                        {recentActivity.map((activity) => {
                            const animeId = activity.anime?.id;
